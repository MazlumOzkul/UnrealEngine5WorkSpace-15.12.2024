...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UTP_PickUpComponent_Statics::NewProp_OnPickUp = { "OnPickUp", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UTP_PickUpComponent, OnPickUp), Z_Construct_UDelegateFunction_CryptRaider_OnPickUp__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnPickUp_MetaData), NewProp_OnPickUp_MetaData) }; // 2676964938
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_unreal_engine_5_4_beginner_file_CryptRaider_CryptRaider_Source_CryptRaider_TP_PickUpComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTP_PickUpComponent, UTP_PickUpComponent::StaticClass, TEXT("UTP_PickUpComponent"), &Z_Registration_Info_UClass_UTP_PickUpComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_PickUpComponent), 3807303991U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_unreal_engine_5_4_beginner_file_CryptRaider_CryptRaider_Source_CryptRaider_TP_PickUpComponent_h_3582225982(TEXT("/Script/CryptRaider"),
	Z_CompiledInDeferFile_FID_unreal_engine_5_4_beginner_file_CryptRaider_CryptRaider_Source_CryptRaider_TP_PickUpComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_unreal_engine_5_4_beginner_file_CryptRaider_CryptRaider_Source_CryptRaider_TP_PickUpComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
